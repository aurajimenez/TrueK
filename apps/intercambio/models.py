...
class Intercambio(models.Model):
	...
	estado = models.EmailField(max_length=254, choices = ESTADOS)
	fecha_solicitud_intercambio = models.DateField(verbose_name= "Fecha de solicitud de intercambio", blank=False, null=False)
	fecha_aceptacion_intercambio = models.DateField(verbose_name= "Fecha de aceptación de intercambio", blank=False, null=False)
