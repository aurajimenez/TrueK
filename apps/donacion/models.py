...
class Donacion(models.Model):
	...
	estado = models.CharField(max_length=70, choices=ESTADOS, default='Vigente')
	fecha_donacion = models.DateField(verbose_name="Fecha de donación", default=date.today())
